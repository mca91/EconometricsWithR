...
A cubic model for instance can be estimated in the same way as the quadratic model; we just have to use a polynomial of degree $r=3$ in  `r ttcode("income")`. This conveniently done using the function `r ttcode("poly()")`.
