...
Just like for the previous chapter, the packages <tt>AER</tt> and <tt>stargazer</tt> are required for reproduction of the code presented in this chapter. Check whether the code chunk below executes without any error messages.
...
stargazer(Journals_mod1, Journals_mod2, Journals_mod3, Journals_mod4,
          ...
          model.numbers = FALSE,
          header=FALSE,
          title = "Nonlinear Regression Models of Journal Subscribtions",
          column.labels = c("(I)", "(II)", "(III)", "(IV)")
          )
```
...
stargazer(TestScore_mod1, 
          ...
          TestScore_mod7,
          digits = 2,
          title = "(\\#tab:nmots) Nonlinear Models of Test Scores",
          type = "html", 
          model.numbers = FALSE,
          header=FALSE,
          column.labels = c("(1)", "(2)", "(3)", "(4)", "(5)", "(6)", "(7)")
...
Let us summarize what can be concluded Table \@ref(tab:nmots).
