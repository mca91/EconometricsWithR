...
The package <tt>MASS</tt> has been loaded. The model object from the above regression is available as <tt>mod</tt> in your working environment.

**Instructions:**

  + Compute the correlation between <tt>medv</tt> and <tt>lstat</tt>.
  
  + Plot <tt>medv</tt> against <tt>lstat</tt> and add the regression line from the model object <tt>mod</tt>. What do you notice?
