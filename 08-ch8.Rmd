...
with $old_i$ defined as in the previous exercise and $indus_i$ being the proportion of non-retail business acres per town.
...
**Instructions:**
  ...
  + Plot <tt>medv</tt> against <tt>indus</tt> and add the regression line for 
...
**Instructions:**
  ...
  + Conduct the regression from above and assign it to <tt>mod_cc</tt>.
