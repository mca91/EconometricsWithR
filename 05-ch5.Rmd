...
$$ Y_i \overset{i.i.d}{\sim} N(5,25), \ i = 1, \dots, 100.$$
<div class="unfolded">
```{r, fig.align='center'}
...
where $\mu$ is an unknown constant and we know that $\epsilon_i \overset{i.i.d.}{\sim} N(0,25)$. In this model, the OLS estimator for $\mu$ is given by $$ \hat\mu = \overline{Y} = \frac{1}{n} \sum_{i=1}^n Y_i, $$ i.e., the sample average of the $Y_i$. It further holds that
...
\[  -2.279808 \pm 1.96 \times 0.4798255 \, \Rightarrow \, \text{CI}_{0.95}^{\beta_1} = \left[ -3.22, -1.34 \right]  \]
