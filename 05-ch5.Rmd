...
<div data-datacamp-exercise data-lang="r">
  ...
  <code data-type="solution">
  coeftest(dummy_mod, vcov. = vcovHC, type = "HC1")
  # or
  linearHypothesis(dummy_mod, "genderfemale=0", vcov. = vcovHC, type = "HC1")
  </code>
  <code data-type="sct">
...
+ Compute robust standard errors of the type <tt>HC1</tt> for the coefficients estimators in the model object <tt>gender_mod</tt>. Store the standard errors in a vector named <tt>rob_SEs</tt>.
