...
The model specifications (4) to (7) include covariates that shall capture the effect of economic conditions of the overall state as well as the legal framework. Considering (4) as the baseline specification, we observe four interesting results:
