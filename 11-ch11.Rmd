...
In `r ttcode("R")`, Probit models can be estimated using the function `r ttcode("glm()")` from the package `r ttcode("stats")`. Using the argument `r ttcode("family")` we specify that we want to use a Probit link function.
