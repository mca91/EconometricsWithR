...
<tt>fastfood.dat</tt>, the dataset used by Card & Krueger (1994) can be downloaded [here](https://github.com/mca91/EconometricsWithR/raw/master/data/fastfood.dta). See this [link](http://www.stat.ucla.edu/projects/datasets/fastfood-explanation.html) for a detailed explanation of the variables.
