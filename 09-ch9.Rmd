...
1. Heteroskedasticity: implications of heteroskedasticiy have been discussed in Chapter 5. Heteroskedasticity-robust standard errors as computed by the function `r ttcode("vcovHC()")` from the package `r ttcode("sandwich")` produce valid standard errors under heteroskedasticity.
...
We continue by estimating most of the model specifications used for analysis of the `r ttcode("CASchools")` data set in Chapter 8 and use `r ttcode("stargazer()")` to generate a tabular representation of the regression results.
