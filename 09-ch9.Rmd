...
We say a statistical analysis has \\textit{internal} validity if the statistical inferences made about causal effects are valid for the considered population.\\newline
...
We continue by estimating most of the model specifications used for analysis of the `r ttcode("CASchools")` data set in Chapter \@ref(nrf) and use `r ttcode("stargazer()")` to generate a tabular representation of the regression results.
