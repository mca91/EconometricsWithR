...
If for example a school cuts the class sizes by hiring new teachers, that is the school lowers the student-teacher ratios ($X_1$) of their classes, how would this affect the performance of the students involved in a standardized test ($Y$)? With linear regression we can not only examine whether the student-teacher ratio *does have* an impact on the test results but we can also learn about the *direction* and the *strength* of this effect. 
...
<iframe height="410" width="900" frameborder="0" scrolling="no" src="file:///URFITE%20Bookdown/SimpleRegression.html"></iframe>
...
<iframe height="410" width="900" frameborder="0" scrolling="no" src="file:///URFITE%20Bookdown/Outlier.html"></iframe>
...
<iframe height="470" width="800" frameborder="0" scrolling="no" src="file:///URFITE%20Bookdown/SmallSampleDIstReg.html"></iframe>
