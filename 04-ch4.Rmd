...
+ `r ttcode("AER")` accompanies the Book *Applied Econometrics with R* and provides useful functions and data sets.

+ `r ttcode("MASS")` is a collection of functions for applied statistics.
