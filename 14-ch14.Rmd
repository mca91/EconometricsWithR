...
GDP is commonly defined as the total value of goods and services produced during a given time period. The dataset us_macro_quarterly.xlsx, provided at [GitHub](https://github.com/mca91/EconometricsWithR/raw/master/data/us_macro_quarterly.xlsx), contains quarterly data on U.S. real GDP (i.e., inflation-adjusted) from 1947 to 2004.
...
We start by importing monthly data from 1931:1 to 2002:12 on excess returns of a broad-based index of stock prices, the CRSP value-weighted index. The data are available at [GitHub](https://github.com/mca91/EconometricsWithR/raw/master/data/Stock_Returns_1931_2002.xlsx).
...
```{r}
#Alternatively, the data can be downloaded directly from GitHub.

tmp <- tempfile(fileext = ".xlsx")
download.file("https://github.com/mca91/EconometricsWithR/raw/master/data/Stock_Returns_1931_2002.xlsx",
              destfile = tmp, mode = "wb")
SReturns <- read_xlsx(tmp, sheet = 1, col_types = "numeric")
