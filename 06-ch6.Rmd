...
test_or({
  ...
  f <- ex() %>% override_solution("coeftest(bh_mod, vcov. = vcovHC, type = "HC0")") %>% check_function("coeftest")
  f %>% check_arg("x") %>% check_equal()
  f %>% check_arg("vcov.") %>% check_equal()
},{
  f <- ex() %>% override_solution("coeftest(bh_mod, vcov. = vcovHC, type = "HC1")") %>% check_function("coeftest")
  f %>% check_arg("x") %>% check_equal()
  f %>% check_arg("vcov.") %>% check_equal()
})
