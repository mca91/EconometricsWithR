...
**Instructions:**
  ...
  + Randomly draw 1000 observations from the $\mathcal{N}(10, 25)$ distribution and compute an estimate with <tt>Y_tilde().         Repeat this procedure 10000 times and store the results in <tt>est_consistent</tt>. 
