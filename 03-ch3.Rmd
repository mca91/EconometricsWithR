...
is a 95\% confidence interval for $d$. <br> In R, Hypotheses as in \@ref(eq:hypmeans) can be tested with `t.test()`, too. Note that `t.test()` chooses $d_0 = 0$ by default. This can changed by setting the argument `mu` accordingly.
