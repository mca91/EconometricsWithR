...
The data set `r ttcode("us_macro_quarterly.xlsx")` is available at [GitHub](https://github.com/mca91/EconometricsWithR/raw/master/data/us_macro_quarterly.xlsx) and contains quarterly data on U.S. real (i.e., inflation adjusted) GDP from 1957 to 2004. We begin by importing the data set and do some formatting (we already worked with this data set in Chapter \@ref(ittsraf) so you may skip these steps if you have already loaded the data in your working environment).
