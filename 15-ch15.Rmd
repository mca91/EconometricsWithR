...
Notice that the standard errors are computed using a HAC estimator of the model variance-covariance matrix, a matter that will not be further commented at this point, see Chapter 14.5 for a discussion of this estimator.
...
The package `r ttcode("sandwich")` also contains the function `r ttcode("NeweyWest()")`, an implementation of the HAC variance-covariance estimator proposed by Newey and West (1987).
